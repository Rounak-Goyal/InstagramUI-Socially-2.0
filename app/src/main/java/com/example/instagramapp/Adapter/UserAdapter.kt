                   ...
                   : RecyclerView.Adapter<UserAdapter.ViewHolder>()
{
    ...
    {
        var userNameTextView: TextView = itemView.findViewById(R.id.user_user_name_search)
        var fullNameTextView: TextView = itemView.findViewById(R.id.user_full_name_search)
        var userImage: CircleImageView = itemView.findViewById(R.id.user_profile_image_search)
        var followButton: Button = itemView.findViewById(R.id.user_follow_btn_search)
    }
